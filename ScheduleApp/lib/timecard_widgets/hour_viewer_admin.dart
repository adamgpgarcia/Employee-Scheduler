          ...
          Row(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text("Total ${countAllHours(shift, userTimeCard).toString()} hr", style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold)),
              ),
              Spacer(),
              Padding(
 ...
 //Text(countAllHours(shift, userTimeCard).toString())
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: <Widget>[
              Column(children:<Widget>[Text("${timeCalulations.regTime}", style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),), Text("Reg"),]),Text(" "),
              Column(children:<Widget>[Text("${timeCalulations.overTime}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),), Text("OT1"),]),Text(" "),
              Column(children:<Widget>[Text("${timeCalulations.doubleTime}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),), Text("OT2"),]),Text(" "),
              Column(children:<Widget>[Text("${timeCalulations.lunchTime}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),), Text("Lunch"),])
            ],),
