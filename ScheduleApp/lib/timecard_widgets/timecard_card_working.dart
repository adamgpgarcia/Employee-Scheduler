...
class TimeCardWorking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double minute = shift.hoursWorked(userTimeCard.shift.startTime, userTimeCard.shift.endTime);
    int formattedHour = shift.hoursWorked(userTimeCard.shift.startTime, userTimeCard.shift.endTime).toInt();
            ...
            child: Row(
              children: <Widget>[
                ...
                Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: <Widget>[
                    Text("${formattedHour}h ${formattedMinute}m", style: TextStyle(fontSize: 20)
                ...
                Center(
                  child: Padding(
                    ...
                    child: IconButton(
                      ...
                      color: Colors.black,
                      onPressed: () {
                         Navigator.of(context).pushNamed(TimecardForm.routeName,arguments: userTimeCard);
                      },
                    ),
                  ),
                ),
