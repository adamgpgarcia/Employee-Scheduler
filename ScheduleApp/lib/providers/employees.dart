...
class Employees with ChangeNotifier {
  ...
  //gets list of employees from the database
  ...
  Future<void> updateEmployees(
      String token, int id, EmployeeAccount editiedEmployee) async {
    var headers = {
      'Content-Type': 'application/json',
      'Authorization': "token $token"
    };

    final index = _employeeList
        .indexWhere((item) => item.employeeID == editiedEmployee.employeeID);
  ...
  Future<void> createEmployee(
      String token, String password, EmployeeAccount employee) async {
    var headers = {
      'Content-Type': 'application/json',
      'Authorization': "token $token"
    };
  ...
  Future<void> deleteEmployee(int id, String token) async {
    ...
    final employeeIndex =
        _employeeList.indexWhere((item) => item.employeeID == id);
