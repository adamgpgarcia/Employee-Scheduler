...
//this widget displays a single employee and allows for editing and deleting
...
class _SingleEmployeeScreenState extends State<SingleEmployeeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          AppBar(title: Text('Employee: ${args.firstName} ${args.lastName}')),
      body: Center(
        child: Container(
          width: 300,
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        Navigator.of(context)
                            .pushNamed(EmployeeForm.routeName, arguments: args);
                      },
                      child: Text("Edit"),
