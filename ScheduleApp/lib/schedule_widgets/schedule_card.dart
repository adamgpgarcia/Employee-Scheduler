...
//this widget shows info on the shift, who has it, what time, the position
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text(
                    DateFormat.E()
                        .format(widget.weekSchedule[widget.index].startTime),
                    style:
                  ...
                  if (widget.weekSchedule[widget.index].employeeID == auth.user)
                    if (widget.weekSchedule[widget.index].release == true)
                      RaisedButton(
                        ...
                        onPressed: () {
                          widget.weekSchedule[widget.index].release =
                              !widget.weekSchedule[widget.index].release;
                          schedule.updateShift(
                              widget.weekSchedule[widget.index],
                              widget.weekSchedule[widget.index].shiftID,
                              auth.token);
                        },
                        child: Text(
                          "Released",
